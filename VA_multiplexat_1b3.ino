...
float corectie1 = 1.2;  // correction factor for reading when is use multiplexing method and other causes
float corectie2 = 0.997;  // correction factor for reading voltage when is use multiplexing method and other causes
